...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5892025232:AAFbKDkpTavtb-hjyEBSbN-IFJS8VthiJ3w"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Imperial Chatbot'
username = 'imperialchatbot'
